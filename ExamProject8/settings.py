"""
Django settings for ExamProject8 project.
...
SECRET_KEY = 'django-insecure-0-e$88dln0jyz4q2eutz=yt4%je)--hu*v7^)uu&(u^%t_7e-1'
...
ROOT_URLCONF = 'ExamProject8.urls'
...
WSGI_APPLICATION = 'ExamProject8.wsgi.application'
